      ...
      <header className="relative z-10 border-b border-[#fecdd3]/70 bg-white/85 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-[1140px] items-center justify-between gap-3 px-4 sm:px-6 md:h-20 md:px-9">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <Link
              to="/admin"
              className="inline-flex items-center gap-2 rounded-full border border-[#4c0519]/15 bg-gradient-to-r from-[#4c0519] to-[#7f1235] px-3 py-2 text-[11px] font-semibold text-white shadow-[0_10px_24px_rgba(76,5,25,0.28)] transition hover:-translate-y-0.5 sm:px-4 sm:py-2.5 sm:text-xs"
            >
